...
func (ec *executionContext) _Subscription_voted(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = nil
	...
	return func() graphql.Marshaler {
		...
		return graphql.WriterFunc(func(w io.Writer) {
			...
			w.Write([]byte{':'})
			ec.marshalNVote2ᚖgithubᚗcomᚋlfreiᚋsurveyᚋvoteᚑserviceᚋgraphᚋmodelᚐVote(ctx, field.Selections, res).MarshalGQL(w)
			w.Write([]byte{'}'})
		})
	}
}
...
func (ec *executionContext) _Vote_name(ctx context.Context, field graphql.CollectedField, obj *model.Vote) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Subscription(ctx context.Context, sel ast.SelectionSet) func() graphql.Marshaler {
	...
	case "voted":
		return ec._Subscription_voted(ctx, fields[0])
	default:
...
func (ec *executionContext) marshalNVote2githubᚗcomᚋlfreiᚋsurveyᚋvoteᚑserviceᚋgraphᚋmodelᚐVote(ctx context.Context, sel ast.SelectionSet, v model.Vote) graphql.Marshaler {
	return ec._Vote(ctx, sel, &v)
}

func (ec *executionContext) marshalNVote2ᚖgithubᚗcomᚋlfreiᚋsurveyᚋvoteᚑserviceᚋgraphᚋmodelᚐVote(ctx context.Context, sel ast.SelectionSet, v *model.Vote) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
